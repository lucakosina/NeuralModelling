...
block_structure = [
    ...
    {'feedback': 'trajectory', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert, 'motor_noise': 3, 'friction': 0.993}, # 10 trials without perturbation
    {'feedback': 'trajectory', 'perturbation': True, 'gradual': False, 'num_trials': n_pert, 'motor_noise': 3, 'friction': 0.993,
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_ESCAPE:
                ...
                if current_block > len(block_structure):
                    ...
                    # save df to csv
                    df_positions.to_csv(path + 'trial_positions_extra.csv', index=False)
