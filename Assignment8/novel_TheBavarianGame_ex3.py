...
def draw_feedback():
    ...
    if feedback_mode:
        if feedback_type == 'trajectory':
            ...
            pygame.draw.circle(screen, YELLOW, end_pos, pint_radius, 5)
            pygame.display.flip()
            pygame.time.wait(1000)

        elif feedback_type == 'rl' and stopped:
            # display red or green circle around initial position based on hit
            if hit:
        ...
        elif feedback_type == 'speed':
            # display current speed of pint
            speed = math.sqrt(pint_velocity[0]**2 + pint_velocity[1]**2)
...
#     {'feedback': None, 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
#     {'feedback': None, 'perturbation': True, 'gradual': True, 'num_trials': n_pert, 'initial_force': 0.2, 'sudden_force': 2.0},  # 30 trials with gradual perturbation
#     {'feedback': None, 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation

#     ### CHANGED START ###

#     # ADD Trajectory feedback
#     {'feedback': 'trajectory', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
#     {'feedback': 'trajectory', 'perturbation': True, 'gradual': True, 'num_trials': n_pert, 'initial_force': 0.2, 'sudden_force': 2.0},  # 30 trials with gradual perturbation
#     {'feedback': 'trajectory', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
#     # ADD End position feedback
#     {'feedback': 'endpos', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
#     {'feedback': 'endpos', 'perturbation': True, 'gradual': True, 'num_trials': n_pert, 'initial_force': 0.2, 'sudden_force': 2.0},  # 30 trials with gradual perturbation
#     {'feedback': 'endpos', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
#     # ADD RL feedback
#     {'feedback': 'rl', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
#     {'feedback': 'rl', 'perturbation': True, 'gradual': True, 'num_trials': n_pert, 'initial_force': 0.2, 'sudden_force': 2.0},  # 30 trials with gradual perturbation
#     {'feedback': 'rl', 'perturbation': False, 'gradual': False, 'num_trials': n_unpert},  # 10 trials without perturbation
...
block_structure = [
    #Normal visual feedback
    {'feedback': 'speed', 'perturbation': False, 'gradual': False, 'num_trials': 10},  # 10 trials without perturbation
    {'feedback': 'speed', 'perturbation': True, 'gradual': True, 'num_trials': 30, 'initial_force': 0.2, 'sudden_force': 2.0},  # 30 trials with gradual perturbation
    {'feedback': 'speed', 'perturbation': False, 'gradual': False, 'num_trials': 10},  # 10 trials without perturbation
]
...
# Determine if the beer pint should be masked
    mask_pint = launched and feedback_mode and feedback_type in ('trajectory', 'rl', 'endpos', 'speed')
    ...
    if feedback_type not in ('rl', 'endpos', 'trajectory', 'speed'):
...
df_positions = pd.read_csv(path + 'trial_positions_novel.csv')
...
# save df to csv
#df_positions.to_csv(path + 'trial_positions_novel.csv', index=False)
...
plt.tight_layout()
plt.savefig(path + 'trial_positions_novel.png')
plt.show()
